...
const WithdrawEarlier = ({ isOpen, onClose, symbol }: WithdrawEarlierProps) => {
  return (
    <Modal
      placement="center"
      isOpen={isOpen}
      ...
      <ModalContent className="w-[calc(100vw-1.24rem)] px-5 py-0 md:w-[25rem]">
        ...
        <ModalBody className="flex w-full flex-col items-center justify-center gap-5 px-0 py-5">
          <p className="m-0 text-center text-[0.75rem] font-bold text-foreground">
            Since the deposit term doesn’t end yet, you’ll be charged a penalty of 3 times the KTON
            reward if you try to withdraw the RINGs in advance.
          </p>
